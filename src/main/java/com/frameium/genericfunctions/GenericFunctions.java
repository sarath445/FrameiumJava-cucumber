...
//		System.out.println(violation.getString("impact"));
	...
	public static JSONArray performAccessibility() throws Exception {
...
//	    Thread.sleep(1000);
	 ...
	 */
	public static void createAccessibilityReport(JSONArray violationsArray, int indexCount, int passedCount, int failedCount,
